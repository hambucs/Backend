...
namespace Backend.Migrations
{
    ...
    [Migration("20241111202424_AddEmailToUser")]
            ...
            modelBuilder.Entity("Szakdoga.Backend.Models.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CarID = 1,
                            RentalEnd = new DateTime(2024, 11, 13, 21, 24, 23, 923, DateTimeKind.Local).AddTicks(1775),
                            RentalStart = new DateTime(2024, 11, 11, 21, 24, 23, 923, DateTimeKind.Local).AddTicks(1726),
                            RenterID = 1
                        });
                });
