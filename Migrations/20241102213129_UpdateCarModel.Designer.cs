...
namespace Backend.Migrations
{
    ...
    [Migration("20241102213129_UpdateCarModel")]
            ...
            modelBuilder.Entity("Szakdoga.Backend.Models.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CarID = 1,
                            RentalEnd = new DateTime(2024, 11, 4, 22, 31, 29, 147, DateTimeKind.Local).AddTicks(8731),
                            RentalStart = new DateTime(2024, 11, 2, 22, 31, 29, 147, DateTimeKind.Local).AddTicks(8680),
                            RenterID = 1
                        });
                });
