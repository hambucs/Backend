...
namespace Backend.Migrations
{
    ...
    [Migration("20241102201010_InitialCreate")]
            ...
            modelBuilder.Entity("Szakdoga.Backend.Models.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CarID = 1,
                            RentalEnd = new DateTime(2024, 11, 4, 21, 10, 10, 269, DateTimeKind.Local).AddTicks(2311),
                            RentalStart = new DateTime(2024, 11, 2, 21, 10, 10, 269, DateTimeKind.Local).AddTicks(2261),
                            RenterID = 1
                        });
                });
