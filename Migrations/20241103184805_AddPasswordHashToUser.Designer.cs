...
namespace Backend.Migrations
{
    ...
    [Migration("20241103184805_AddPasswordHashToUser")]
            ...
            modelBuilder.Entity("Szakdoga.Backend.Models.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CarID = 1,
                            RentalEnd = new DateTime(2024, 11, 5, 19, 48, 5, 502, DateTimeKind.Local).AddTicks(2575),
                            RentalStart = new DateTime(2024, 11, 3, 19, 48, 5, 502, DateTimeKind.Local).AddTicks(2522),
                            RenterID = 1
                        });
                });
